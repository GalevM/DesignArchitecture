...
#
# df = pd.read_csv("scraped_data_sentiment.csv")
# df_copy = df.dropna(axis=0)
# print(len(df_copy["Issuer"].unique()))
#
...
#
# sentimentModel = pipeline("sentiment-analysis", max_length=200000000, truncation=True)
#
# sentForIssuer = {}
#
# for issuer in issuers:
#     content_for_issuer = df[df['Issuer'] == issuer + "/"]['Content'].tolist()
#     full_content = ' '.join(content_for_issuer)
#     sentiment = sentimentModel(full_content)
#     sentForIssuer[issuer] = sentiment[0]['label']
#     print(sentForIssuer)
#
#
# print(sentForIssuer)
